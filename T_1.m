...
%Interface processing is rigorously taken care of. Different from the horizontal slowness shooting ray tracing method 
%(Ma et al., 2020, Geophysics, Joint microseismic event location and anisotropic velocity inversion with the cross double-difference method using downhole microseismic data). 
